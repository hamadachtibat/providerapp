...
class LanguageScreen extends StatefulWidget {
  ...
  const LanguageScreen({Key? key, this.openLogin = true, this.redraw}) : super(key: key);
  @override
        ...
        child: Stack(
              children: [
                ...
                Container(
                  ...
                  child: button2(strings.get(2), // "SUBMIT",
                      theme.mainColor, (){_submit();}, style: theme.style16W800White, radius: 50),
                )
              ]),
        ));
  }
        ...
        children: [
          Container(
            ...
            child: Container(
              ...
              child: Image.asset("assets/ondemand/ondemand3.png", fit: BoxFit.cover),
            ),
