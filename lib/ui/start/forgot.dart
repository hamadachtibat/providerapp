...
class _ForgotScreenState extends State<ForgotScreen> {
              ...
              child: Row(
                children: [
                  Expanded(
                    ...
                    children: [
                      Text(strings.get(182), /// "Forgot password?",
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text(strings.get(183), /// "Reset password",
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 20, right: 20),
                      child: button2(strings.get(184), theme.mainColor, _reset)), /// "Send new password",
  ...
  _reset() async {
    ...
    _waits(false);
    messageOk(context, strings.get(185)); /// "Reset password email sent. Please check your mail."
  }
